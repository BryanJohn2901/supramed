(function () {
    var NAV = [
        ...
        { id: 'atuacao', href: 'nossas-atuacoes.html', label: 'Nossa Atuação' },
        { id: 'quem-somos', href: 'quem-somos.html', label: 'Quem Somos' },
        { id: 'cases', href: 'cases.html', label: 'Cases' },
                ...
                '<div class="main-nav bg-[#FFFFFF] border-b border-gray-200/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300">' +
                    '<div class="container mx-auto px-6 py-4 flex justify-between items-center gap-4">' +
                        '<a href="index.html" class="flex items-center shrink-0 group" aria-label="Supramed Saúde — Home">' +
                            '<img src="logo.jpeg" alt="Supramed Saúde" width="260" height="60" class="h-12 sm:h-14 w-auto max-w-[260px] object-contain object-left transition-opacity duration-300 group-hover:opacity-90">' +
                        '</a>' +
                ...
                '<div class="container mx-auto px-6">' +
                    '<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">' +
                        '<div class="lg:col-span-4 pr-0 lg:pr-8">' +
                            '<a href="index.html" class="inline-block mb-6"><img src="logo.jpeg" alt="Supramed Saúde" class="h-12 w-auto brightness-0 invert opacity-95"></a>' +
